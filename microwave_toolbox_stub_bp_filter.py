...
network = shunt_match1.network ** phase_match1.network ** shunt_match2.network ** phase_match2.network ** shunt_match2.network ** phase_match1.network ** shunt_match1.network
